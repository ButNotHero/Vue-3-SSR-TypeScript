...
export interface CounterActionsTypes1 {
  ...
  [COUNTER1_STORE.ACTIONS.CALL_COUNTER1]({ commit }: AugmentedActionContextCounter1): void;
}
...
export interface CounterActionsTypes {
  [COUNTER_STORE.ACTIONS.GET_COUNTER]({ commit }: AugmentedActionContext, payload: number): void;
  [COUNTER_STORE.ACTIONS.SET_ROOT_DISPATCH](
    { commit }: AugmentedActionContext,
    payload: boolean,
  ): void;
  [COUNTER_STORE.ACTIONS.CALL_COUNTER]({ commit }: AugmentedActionContext, payload: boolean): void;
}

export interface StoreActions extends RootActionsTypes, CounterActionsTypes, CounterActionsTypes1 {}
