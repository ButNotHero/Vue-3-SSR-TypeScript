...
import { Counter1StateTypes, CounterActionsTypes1, IRootState } from '@/store/interfaces';
import { COUNTER1_STORE, COUNTER_STORE } from '@/store/constants';

export const actions: ActionTree<Counter1StateTypes, IRootState> & CounterActionsTypes1 = {
